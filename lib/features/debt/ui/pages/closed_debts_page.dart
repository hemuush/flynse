...
/// This page now only displays the user's closed personal debts.
class ClosedDebtsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Your Closed Debts'),
      ),
      body: Consumer<DebtProvider>(
        builder: (context, debtProvider, child) {
          ...
          if (completedUserDebts.isEmpty) {
            return const Center(
              child: Text('No closed debts to display.'),
            );
          }
